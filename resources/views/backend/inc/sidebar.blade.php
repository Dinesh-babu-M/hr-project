        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="#pages-companies" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            Companies <i class="las la-angle-right sidemenu-right-icon"></i> </a>
                    ...
                    <li>
                        <a href="#pages-ecommerce" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            Ecommerce <i class="las la-angle-right sidemenu-right-icon"></i> </a>
                    ...
                    <li>
                        <a href="#pages-email" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            Email <i class="las la-angle-right sidemenu-right-icon"></i> </a>
                    ...
                    <li>
                        <a href="#pages-notes" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            Notes <i class="las la-angle-right sidemenu-right-icon"></i> </a>
                    ...
                    <li>
                        <a href="#pages-error" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            Tickets <i class="las la-angle-right sidemenu-right-icon"></i> </a>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="authentication" data-parent="#accordionExample">
                    <li>
                        <a href="#pages-auth-one" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            Type 1 <i class="las la-angle-right sidemenu-right-icon"></i> </a>
                    ...
                    <li>
                        <a href="#pages-auth-two" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            Type 2 <i class="las la-angle-right sidemenu-right-icon"></i> </a>
                    ...
                    <li>
                        <a href="#pages-auth-three" data-toggle="collapse" aria-expanded="false"
                            class="dropdown-toggle"> Type 3
                            <!-- <i class="las la-angle-right sidemenu-right-icon"></i>  -->
                            <span class="menu-badge badge-danger">New</span>
                        </a>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="pages" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="#pages-error" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            Error <i class="las la-angle-right sidemenu-right-icon"></i> </a>
                        <ul class="collapse list-unstyled sub-submenu" id="pages-error" data-parent="#pages">
                            <li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="forms" data-parent="#accordionExample">
                    <li>
                        <a href="#form-control" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            Controls <i class="las la-angle-right sidemenu-right-icon"></i> </a>
                    ...
                    <li>
                        <a href="#form-widget" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            Widgets <i class="las la-angle-right sidemenu-right-icon"></i> </a>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="multi-level" data-parent="#accordionExample">
                    <li>
                        <a href="#level-two" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Level
                    ...
                    <li>
                        <a href="#level-three" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            Level 3 <i class="las la-angle-right sidemenu-right-icon"></i> </a>
                        <ul class="collapse list-unstyled sub-submenu" id="level-three" data-parent="#pages">
                            <li>
                                <a href="javascript:void(0)"> Link 1</a>
                            </li>
                            <li>
                                <a href="#level-four" data-toggle="collapse" aria-expanded="false"
                                    class="dropdown-toggle"> Link 2 <i
